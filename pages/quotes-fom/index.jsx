  ...
  return (
    <Layout>
      <article className="w-[360px] h-[650px] bg-gray-black absolute top-0 left-0 bottom-0 right-0 m-auto rounded-md heroImg flex flex-col gap-5 items-center py-12">
        ...
        {imageUrl && (
          <img src={imageUrl} className="h-[200px] w-[200px]  rounded" />
        )}
        {image && (
          <img
            src={image}
            ...
            <div className="fixed top-0 left-0 bottom-0 right-0  flex flex-col items-center justify-center ">
              ...
              >
                <form className="flex flex-col gap-5  items-center">
                  ...
                  <div className="flex ">
                    <span className="flex items-center justify-between px-5 w-[300px]  font-montserrat h-12  text-white bg-black shadow-lg shadow-black py-2 rounded-full">
                      Area of the body
                      <select
                        data-te-select-init
                        value={bodyPart}
                      ...
                      >
                        <option value="" className="rounded font-montserrat  ">
                          Select an option
                        </option>
                        {options.map((option) => (
                          <option
