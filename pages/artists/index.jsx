                ...
                <article className="w-[670px] h-[550px] bg-gray-black absolute top-0 left-0 bottom-0 right-0 m-auto rounded-md heroImg flex flex-col gap-6 items-center py-12 px-1">
                    ...
                    <section className="flex flex-wrap gap-3 items-center justify-center  w-[100%] text-center p-2">
                        {arrayStyles.map((item, index) => (
                            <article
                                className="flex gap-1 items-center justify-center bg-black rounded-sm  h-[100px] px-2  w-[200px] hover:bg-red-600 cursor-pointer transition ease-in-out delay-150  hover:-translate-y-1 hover:scale-110  duration-75"
                                key={index}
                                onClick={() => {
                                    setModalOpen(true);
